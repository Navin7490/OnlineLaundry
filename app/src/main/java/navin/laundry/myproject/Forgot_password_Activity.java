...
public class Forgot_password_Activity extends AppCompatActivity {
   ...
   Toast toast;
    ...
    String FETCH_EMAIL_URL="https://navindeveloperinfo.000webhostapp.com/laundry_service/api/forgotpassword_emailfetch.php";
    String CHANGE_PASSWORD_URL="https://navindeveloperinfo.000webhostapp.com/laundry_service/api/change_password.php";
