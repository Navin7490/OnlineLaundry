 ...
 */
public class Shirt_Fragment extends Fragment {
    View v;
    RecyclerView.LayoutManager layoutManager;
    RecyclerView recyclerView;
    ArrayList<Product_Fragment_modal> prodct;
    public Shirt_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v=inflater.inflate(R.layout.fragment_shirt_, container, false);

        recyclerView =v.findViewById(R.id.RvMen_shirt);
