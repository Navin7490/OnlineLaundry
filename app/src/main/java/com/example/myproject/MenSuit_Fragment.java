 ...
 */
public class MenSuit_Fragment extends Fragment {
    View v;
    RecyclerView.LayoutManager layoutManager;
    RecyclerView recyclerView;
    ArrayList<Product_Fragment_modal> prodct;
    public MenSuit_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v=inflater.inflate(R.layout.fragment_men_suit_, container, false);

        recyclerView =v.findViewById(R.id.RvMen_suit);
